...
function (_walletcs$WalletHDInt2) {
  ...
  _createClass(EtherWalletHD, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee4(mnemonic) {
        var node;
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee5(prv, unsignedTx) {
        var tx, wallet;
      ...
      function signTransactionByPrivateKey(_x9, _x10) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee6(xpriv, unsignedTx, addresses, depth) {
        var i, pair;
      ...
      function signTransactionByxPriv(_x11, _x12, _x13, _x14) {
