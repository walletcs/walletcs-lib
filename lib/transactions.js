    ...
    value: function calculateFee(fee) {
      if (!fee && this.transaction.to.length && this.transaction.amounts.length) {
        try {
          ...
          tx.to(_.zipWith(this.transaction.to, this.transaction.amounts, function (to, amount) {
            return {
              'address': to,
              'satoshis': amount
            };
...
function () {
  ...
  _createClass(TransactionConstructor, [{
    key: "buildBitcoinTx",
    value: function buildBitcoinTx(outxs, from, to, amounts, changeAddress, fee) {
    ...
    value: function buildBitcoinMultiSignTx(outxs, from, to, amounts, changeAddress, fee, threshold) {
      this.builder.setFromAddress(from);
      this.builder.setToAddress(to);
      this.builder.setAmount(amounts);
