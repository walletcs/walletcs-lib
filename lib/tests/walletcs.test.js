...
test('Test sign ether transaction by xPriv with invalid address',
/*#__PURE__*/
_asyncToGenerator(
/*#__PURE__*/
regeneratorRuntime.mark(function _callee8() {
  var wallet, xprv, tx, xprvSinedTx;
  return regeneratorRuntime.wrap(function _callee8$(_context8) {
    while (1) {
      switch (_context8.prev = _context8.next) {
        case 0:
          wallet = new wallets.EtherWalletHD();
          xprv = 'xprv9s21ZrQH143K4bHciWrVe2rWXvBxvVXc54KjtNcYyGfsJN6cWRKSFErAJHvU5yyirhqu9ELproykvhRXg5xudD9W89Y2bxaDBcSjMU5kZqW';
          tx = new transactions.EtherTx();
          tx.to = '0x343E60ACea58388fCba2C21F302312feCf55175A';
          tx.gasPrice = ethers.utils.bigNumberify(1000000000);
          tx.gasLimit = ethers.utils.bigNumberify(21000);
          tx.value = ethers.utils.parseEther("0.0001");
          _context8.next = 9;
          return wallet.signTransactionByxPriv(xprv, tx, ['0x343E60ACea58388fCba2C21F302312feCf55175A']);

        case 9:
          xprvSinedTx = _context8.sent;
...
test('Test sign bitcoin transaction by xPriv with invalid address',
/*#__PURE__*/
_asyncToGenerator(
/*#__PURE__*/
regeneratorRuntime.mark(function _callee9() {
  var network, wallet, xprv, child1, bitcoinFileTx, unsigedTxs, tx, xprvSinedTx;
    ...
    while (1) {
      switch (_context9.prev = _context9.next) {
        case 0:
          ...
          xprv = 'tprv8ZgxMBicQKsPd7Z9HS5DhPQPhL4aotcZLMhDEUqFT7gS9FDhA1F9ZBrBKAFcmAPTjiyF117BpQgdyAzAszSYbQu2NhAcxsTW5HofASryz1i';
          child1 = wallet.getAddressWithPrivateFromXprv(xprv, 10);
          bitcoinFileTx = {
            "outx": [{
...
test('Test sign bitcoin transaction by',
/*#__PURE__*/
_asyncToGenerator(
/*#__PURE__*/
  ...
  return regeneratorRuntime.wrap(function _callee17$(_context17) {
    while (1) {
      switch (_context17.prev = _context17.next) {
        ...
        case 12:
          sinedTx = _context17.sent;
          _context17.next = 15;
          return wallet.signTransactionByxPriv(xprv, tx, [child1.address]);

        case 15:
          xprvSinedTx = _context17.sent;
          expect(sinedTx).toEqual(xprvSinedTx);
...
<<<<<<< HEAD
=======
  var network, wallet, addresses, xprv, pair1, pair2, publicKeys, multiSignAddress, bitcoinFileTx, multiSignTx;
>>>>>>> multisig
    ...
    while (1) {
      switch (_context25.prev = _context25.next) {
        ...
        case 4:
          ...
          pair1 = wallet.getAddressWithPrivateFromXprv(xprv, 0);
          pair2 = wallet.getAddressWithPrivateFromXprv(xprv, 1);
          publicKeys = [pair2.publicKey, pair1.publicKey];
          multiSignAddress = wallets.BitcoinWalletHD.createMultiSignAddress(2, network, publicKeys);
          bitcoinFileTx = {
            "outx": [{
              "txId": "191d12fe3ada580f7af7322b8fcdb840123106659fe1ebb9898c70e1b4232072",
              "outputIndex": 2,
            ...
            "changeAddress": multiSignAddress,
            "fee": null
          };
          multiSignTx = wallet.createMultiSignTx(bitcoinFileTx);
...
test('Test sign multisign by one user',
/*#__PURE__*/
_asyncToGenerator(
/*#__PURE__*/
regeneratorRuntime.mark(function _callee26() {
  var network, wallet, addresses, xprv, pair1, pair2, publicKeys, multiSignAddress, bitcoinFileTx, multiSignTx, signedTx, txSerialized, tx;
  return regeneratorRuntime.wrap(function _callee26$(_context26) {
    while (1) {
      switch (_context26.prev = _context26.next) {
        ...
        case 4:
          addresses = _context26.sent;
          xprv = addresses.xPriv;
          pair1 = wallet.getAddressWithPrivateFromXprv(xprv, 0);
          pair2 = wallet.getAddressWithPrivateFromXprv(xprv, 1);
          publicKeys = [pair2.publicKey, pair1.publicKey];
          multiSignAddress = wallets.BitcoinWalletHD.createMultiSignAddress(1, network, publicKeys);
          bitcoinFileTx = {
            "outx": [{
              "txId": "191d12fe3ada580f7af7322b8fcdb840123106659fe1ebb9898c70e1b4232072",
              "outputIndex": 2,
          ...
          multiSignTx = wallet.createMultiSignTx(bitcoinFileTx);
          _context26.next = 14;
          return wallet.signMultiSignTransactionByPrivateKey(pair1.privateKey, multiSignTx);

        case 14:
          signedTx = _context26.sent;
          txSerialized = wallet.__builtTx(signedTx).toObject();
          tx = new bitcore.Transaction(txSerialized);
...
test('Test sign multisign by two users only one signed',
/*#__PURE__*/
_asyncToGenerator(
/*#__PURE__*/
...
test('Test sign multisign by two users',
/*#__PURE__*/
_asyncToGenerator(
/*#__PURE__*/
regeneratorRuntime.mark(function _callee28() {
  var network, wallet, addresses, xprv, pair1, pair2, publicKeys, multiSignAddress, bitcoinFileTx, multiSignTx, multiSignTx2, signedTx1, signedTx2, combinedTx, txSerialized, tx;
    ...
    while (1) {
      switch (_context28.prev = _context28.next) {
        ...
        case 4:
          ...
          multiSignTx = wallet.createMultiSignTx(bitcoinFileTx);
          multiSignTx2 = JSON.parse(JSON.stringify(multiSignTx));
          _context28.next = 15;
          return wallet.signMultiSignTransactionByPrivateKey(pair1.privateKey, multiSignTx);

        case 15:
          signedTx1 = _context28.sent;
          _context28.next = 18;
          return wallet.signMultiSignTransactionByPrivateKey(pair2.privateKey, multiSignTx2);

        case 18:
          signedTx2 = _context28.sent;
          combinedTx = wallet.combineMultiSignSignatures([signedTx1, signedTx2]);
          txSerialized = wallet.__builtTx(combinedTx).toObject();
          tx = new bitcore.Transaction(txSerialized);
          expect(tx.isFullySigned()).toBeTruthy();
