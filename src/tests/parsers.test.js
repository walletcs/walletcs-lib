...
test('Test parsing not filled bitcoin file out', async ()=> {
  const emptyBitcoinFileTx = {"outx":[],"from":[],"to":[], "changeAddress": "", "fee": null};
